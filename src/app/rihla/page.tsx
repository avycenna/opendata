...
import { filterAndSearchSchools, FilterOptions, School } from "@/lib/data"
...
export default function Page() {
  ...
  const filteredSchools = useMemo(() => {
    return filterAndSearchSchools(filters, deferredSearchQuery)
  ...
  // Sidebar content JSX - used inline to avoid component-in-render issues
